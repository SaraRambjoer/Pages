import { Heading, Box, Card, CardHeader, CardBody, Flex, Text, Highlight, Avatar, Spacer, Center, Stack, Image} from '@chakra-ui/react'
...
export function Aquarium(props: any) {
    return <>
